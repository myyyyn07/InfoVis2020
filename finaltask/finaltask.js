function main()
{
    ...
    document.getElementById("change-slice-button").onclick = function() {
	...
	var normal = new THREE.Vector3( document.getElementById("output").value, document.getElementById("output2").value, document.getElementById("output3").value );
